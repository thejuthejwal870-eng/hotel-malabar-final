    ...
    private fun openAdmin(token: String) {
        ...
        webView.webChromeClient = object : WebChromeClient() {
            override fun onShowFileChooser(
                ...
                return try {
                    // Use the Android system document picker directly. This is
                    // more reliable on Samsung WebView than relying on the
                    // chooser intent generated by Chromium.
                    ...
                    runOnUiThread {
                        android.widget.Toast.makeText(
                            this@MainActivity,
                            "Could not open the audio file picker.",
